...
| # | Course | What I practiced / delivered | Course URL | Repo / PoW | Badge / Cert |
|---|---|---|---|---|---|
| 1 | **Introduction to DevOps** | DevOps culture, CALMS, value streams, SLOs/SLIs | [Course](https://www.coursera.org/learn/intro-to-devops?specialization=devops-and-software-engineering) | <ADD_REPO_OR_NOTES> | [Badge](JDW-Badges/1.devops-essentials.2.png) |
| 2 | **Introduction to Cloud Computing** | IaaS/PaaS/SaaS, regions/zones, shared responsibility | [Course](https://www.coursera.org/learn/introduction-to-cloud?specialization=devops-and-software-engineering) | <ADD_REPO_OR_NOTES> | [Badge](JDW-Badges/2.introduction-to-cloud-computing.png) |
| 3 | **Introduction to Agile Development and Scrum** | Scrum roles/artifacts, user stories, Kanban flows | [Course](https://www.coursera.org/learn/agile-development-and-scrum?specialization=devops-and-software-engineering) | <ADD_REPO_OR_NOTES> | [Badge](JDW-Badges/3.introduction-to-agile-development-and-scrum.png) |
| 4 | **Introduction to Software Engineering** | Requirements → design → testing; SDLC trade-offs | [Course](https://www.coursera.org/learn/introduction-to-software-engineering?specialization=devops-and-software-engineering) | <ADD_REPO_OR_NOTES> | [Badge](JDW-Badges/software-engineering-essentials.png) |
| 5 | **Getting Started with Git and GitHub** | Branch/PR flows, protected branches, code reviews | [Course](https://www.coursera.org/learn/getting-started-with-git-and-github?specialization=devops-and-software-engineering) | [Repo](https://github.com/johndtwaldron/jbbmo-Introduction-to-Git-and-GitHub) | [Badge](JDW-Badges/5.git-and-github-essentials1.png) |
| 6 | **Hands-on Intro to Linux Commands & Shell Scripting** | CLI, pipes/filters, Bash automation | [Course](https://www.coursera.org/learn/hands-on-introduction-to-linux-commands-and-shell-scripting?specialization=devops-and-software-engineering) | <ADD_REPO_OR_NOTES> | [Badge](JDW-Badges/6.linux-commands-shell-scripting-essentials-v2.png) |
| 7 | **Python for Data Science, AI & Development** | Python fundamentals, packaging, venvs | [Course](https://www.coursera.org/learn/python-for-applied-data-science-ai?specialization=devops-and-software-engineering) | <ADD_REPO_OR_NOTES> | [Badge](JDW-Badges/7.python-for-data-science-and-ai.png) |
| 8 | **Developing AI Applications with Python and Flask** | Flask app structure, blueprints, config, APIs | [Course](https://www.coursera.org/learn/python-project-for-ai-application-development?specialization=devops-and-software-engineering) | [Repo](https://github.com/johndtwaldron/oaqjp-final-project-emb-ai) | [Badge](JDW-Badges/8.python-project-for-ai-and-application-development.png) |
| 9 | **Introduction to Containers with Docker, Kubernetes & OpenShift** | Dockerfiles, images, Pods/Deployments/Services, Routes | [Course](https://www.coursera.org/learn/ibm-containers-docker-kubernetes-openshift?specialization=devops-and-software-engineering) | [Repo](https://github.com/johndtwaldron/IBM-guestbook-k8s-lab-JDW-PoW) | [Badge](JDW-Badges/9.containers-kubernetes-essentials.1.png) |
| 10 | **Application Development using Microservices & Serverless** | Microservice boundaries, REST, eventing, FaaS fit | [Course](https://www.coursera.org/learn/applications-development-microservices-serverless-openshift?specialization=devops-and-software-engineering) | [Repo](https://github.com/johndtwaldron/IBM.App.Dev.Microserv.serverless-JDW-POW) | [Badge](JDW-Badges/10.application-development-using-microservices-and-ser.png) |
| 11 | **Introduction to Test & Behavior-Driven Development** | Nose/pytest, BDD mindset, coverage | [Course](https://www.coursera.org/learn/test-and-behavior-driven-development-tdd-bdd?specialization=devops-and-software-engineering) | [Repo](https://github.com/johndtwaldron/IBM-tdd-bdd-final-project-JDW-PoW) | [Badge](JDW-Badges/11.introduction-to-test-driven-development.1.png) |
| 12 | **Continuous Integration & Continuous Delivery (CI/CD)** | Pipelines, artifact promotion, approvals | [Course](https://www.coursera.org/learn/continuous-integration-and-continuous-delivery-ci-cd?specialization=devops-and-software-engineering) | <ADD_REPO_OR_NOTES> | [Badge](JDW-Badges/12.continuous-integration-continuous-delivery-ci-cd.1.png) |
| 13 | **Application Security for Developers & DevOps Professionals** | Threat modeling, SAST/DAST, secrets, headers/CORS | [Course](https://www.coursera.org/learn/application-security-for-developers-devops?specialization=devops-and-software-engineering) | [Repo](https://github.com/johndtwaldron/graphy_server) | [Badge](JDW-Badges/13.devsecops.1757176289358.jpeg) |
| 14 | **Monitoring & Observability for DevOps** | Logs/metrics/traces, alerts, SLO-based dashboards | [Course](https://www.coursera.org/learn/monitoring-and-observability-for-development-and-devops?specialization=devops-and-software-engineering) | <ADD_REPO_OR_NOTES> | [Badge](JDW-Badges/14.monitoring-and-observability-for-development-and-de.png) |
| 15 | **DevOps Capstone Project** | End-to-end PoW: microservice + K8s + Tekton CD | [Course](https://www.coursera.org/learn/devops-capstone-project?specialization=devops-and-software-engineering) | [Repo](https://github.com/johndtwaldron/aolwx-devops-capstone-JDW-PoW) | [Badge](JDW-Badges/15.devops-capstone.png) |
